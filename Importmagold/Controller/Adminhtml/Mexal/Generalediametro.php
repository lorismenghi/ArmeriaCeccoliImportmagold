...
class Generalediametro extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreDiametro();
		$conto_opzioni = count($array_id_valore);
		$etichetta_diametro = $block->getEtichettaDiametro();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_diametro', $etichetta_diametro);
