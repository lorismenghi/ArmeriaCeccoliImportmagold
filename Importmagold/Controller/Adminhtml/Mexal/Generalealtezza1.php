...
class Generalealtezza1 extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreAltezza1();
		$conto_opzioni = count($array_id_valore);
		$etichetta_altezza1 = $block->getEtichettaAltezza1();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_altezza1', $etichetta_altezza1);
