...
class Generalepiomboar extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValorePiomboar();
		$conto_opzioni = count($array_id_valore);
		$etichetta_piomboar = $block->getEtichettaPiomboar();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_piomboar', $etichetta_piomboar);
