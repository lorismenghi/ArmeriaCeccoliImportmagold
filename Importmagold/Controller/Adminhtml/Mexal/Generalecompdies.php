...
class Generalecompdies extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreCompdies();
		$conto_opzioni = count($array_id_valore);
		$etichetta_compdies = $block->getEtichettaCompdies();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_compdies', $etichetta_compdies);
