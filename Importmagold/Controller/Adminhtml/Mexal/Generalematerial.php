...
class Generalematerial extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreMaterial();
		$conto_opzioni = count($array_id_valore);
		$etichetta_material = $block->getEtichettaMaterial();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_material', $etichetta_material);
