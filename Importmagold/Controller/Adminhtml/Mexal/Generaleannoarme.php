...
class Generaleannoarme extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreAnnoarme();
		$conto_opzioni = count($array_id_valore);
		$etichetta_annoarme = $block->getEtichettaAnnoarme();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_annoarme', $etichetta_annoarme);
