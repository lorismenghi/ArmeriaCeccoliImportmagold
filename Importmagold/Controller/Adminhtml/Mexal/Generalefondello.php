...
class Generalefondello extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreFondello();
		$conto_opzioni = count($array_id_valore);
		$etichetta_fondello = $block->getEtichettaFondello();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_fondello', $etichetta_fondello);
