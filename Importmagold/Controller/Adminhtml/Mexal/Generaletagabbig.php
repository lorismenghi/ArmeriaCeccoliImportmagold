...
class Generaletagabbig extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreTagabbig();
		$conto_opzioni = count($array_id_valore);
		$etichetta_tagabbig = $block->getEtichettaTagabbig();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_tagabbig', $etichetta_tagabbig);
