...
class Generalecolpiarm extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
		...
		$array_id_valore = $block->getArrayIdValoreColpiarm();
		$conto_opzioni = count($array_id_valore);
		$etichetta_colpiarm = $block->getEtichettaColpiarm();
		...
		$resultPage->getLayout()->getBlock('lm_importmagold_mexal')->setData('etichetta_colpiarm', $etichetta_colpiarm);
