...
class ImportCliente extends Action
{
    /**
     * @var JsonFactory
     */
    ...
    public function __construct(
        ...
        //importatoreCustomer $importatoreCustomer // non posso metterlo qui perche' non prende poi i parametri
    ) {
    ...
    {
        $result = $this->importCustomerService->importCustomer();
